...
export default class GameDisplay {
    ...
    static #createLabeledGameBoardList(game, reDrawFunction) {
        ...
        divLabeledGameBoardList.appendChild(this.#createLabeledGameBoard(game.player1.name, game.player1.gameBoard, reDrawFunction));
        divLabeledGameBoardList.appendChild(this.#createLabeledGameBoard(game.player2.name, game.player2.gameBoard, reDrawFunction));
        return divLabeledGameBoardList;
    }

    static #createLabeledGameBoard(playerName, gameBoard, reDrawFunction) {
        ...
        GameBoardDisplay.draw(gameBoard, divLabeledGameBoard, reDrawFunction);
